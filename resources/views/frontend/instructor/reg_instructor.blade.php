    ...
    <form action="{{ route('instructor.register') }}" method="post" class="row">
        ...
        <div class="input-box col-lg-6">
            ...
            <div class="form-group">
                <input class="form-control form--control @error('name')
                    is-invalid
        ...
        <div class="input-box col-lg-6">
            ...
            <div class="form-group">
                <input class="form-control form--control @error('username') is-invalud 
                @enderror" type="username" name="username" placeholder="e.g. Smith">
                <span class="la la-user input-icon"></span>
                @error('username')
                <span class="text-danger">{{ $message }}</span>
                @enderror
        ...
        <div class="input-box col-lg-6">
            ...
            <div class="form-group">
                <input class="form-control form--control @error('email') is-invalud 
        ...
        <div class="input-box col-lg-6">
            ...
            <div class="form-group">
                <input id="phone" class="form-control form--control @error('phone') is-invalud @enderror" type="text" name="phone">
                @error('phone')
                <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
        ...
        <div class="input-box col-lg-12">
            ...
            <div class="form-group">
                <input id="address" class="form-control form--control @error('address') is-invalud @enderror" type="text" name="address">
                @error('address')
                <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
        ...
        <div class="input-box col-lg-12">
            ...
            <div class="form-group">
                <input id="password" class="form-control form--control @error('password') is-invalud @enderror" type="password" name="password">
                @error('password')
                <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
