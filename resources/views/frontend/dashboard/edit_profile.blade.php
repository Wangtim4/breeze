...
<div class="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between mb-5">
    <div class="media media-card align-items-center">
        <div class="media-img media--img media-img-md rounded-full">
            <img class="rounded-full" src="{{ (!empty($profileData->photo)) ? url('upload/user_images/'.$profileData->photo) : url('upload/no_image.jpg') }}" alt="Student gthumbnail image">
        </div>
    ...
    @csrf
        ...
        <div class="media media-card align-items-center">
            ...
            <div class="input-box col-lg-12">
                ...
                <div class="form-group">
                    <input class="form-control form--control  pl-3" name="address" type="text" value="{{ $profileData -> address}}">
